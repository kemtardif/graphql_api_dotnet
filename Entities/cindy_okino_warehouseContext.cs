     ...
     protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
       {
           if (!optionsBuilder.IsConfigured)
           {
                ...
                optionsBuilder.UseNpgsql("HOST=codeboxx-postgresql.cq6zrczewpu2.us-east-1.rds.amazonaws.com;Database=cindy_okino_warehouse;port=5432;Username=codeboxx;Password=Codeboxx1!");
           }
        }
